...
const std::string FORM_YES = "Yes"; // what to print into Consent column of output csv if consent form exists
const std::string FORM_NO = ""; // what to print into Consent column of output csv if consent form does not exist

/* Should be more wary about initializing the following parameters */
const std::string NAME_LOG = "log_" + NAME_EVENT + ".txt"; // desired name of log file detailing program events
const std::string NAME_INPUT_CLEAN = "sanitized.csv"; // ignore; needed to sanitize input properly
const std::string NAME_OUTPUT_DUPLICATES = "duplicates.csv"; // ignore; needed to remove duplicates properly
const std::string NAME_ENGLISH = "English"; // how it was indicated in the raw input csv that the forms were filled out in English
const char DELIMITER_CLEAN = '$'; // which singular character to forbid while filling out forms; needed to sanitize input properly
const char DELIMITER_CSV = ','; // how raw input csv delimits cells; needs to be cleaned out by sanitizer function
